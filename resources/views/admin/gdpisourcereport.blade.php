        ...
        <table class="table table-striped table-bordered table-condensed word-breaker">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>NA</td>
              <td>NA</td>
              <td>{{ $admissionform->payment_mode }}</td>
              <td>{{ date('Y-m-d', strtotime($admissionform->date)) }}</td>
              <td>{{ !empty($admissionform->firstsource()) ? $admissionform->firstsource()->source : 'Not Found' }}</td>
