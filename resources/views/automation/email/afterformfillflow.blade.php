...
<body>
 <div id="navigation">
        <div id="leftside">
            ...
            <div id="names">
                <p id="title">After Admission Email automation pipeline</p>
    ...
    <div id="leftcard">
        ...
        <div id="blocklist">
            <div class="sources-list data-list">
                <div class="blockelem create-flowy noselect afterform-single">
                    <input type="hidden" name='blockelemtype' class="blockelemtype" value="source-afterformfill">
                    <div class="grabme">
                    ...
                    <div class="blockin">
                        ...
                        <div class="blocktext">
                            <p class="blocktitle">After Form Filling</p>
                            <p class="blockdesc">Entry Source</p>
                        </div>
                    </div>
                </div>
                <div class="blockelem create-flowy noselect aftergdpi-single">
                    <input type="hidden" name='blockelemtype' class="blockelemtype" value="source-aftergdpigiven">
                    <div class="grabme">
                        <img src="{{ asset('plugins/flowy/assets/grabme.svg') }}">
                    </div>
                    <div class="blockin">
                        ...
                        <div class="blocktext">
                            <p class="blocktitle">After GDPI Given</p>
                            <p class="blockdesc">Entry Source</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="email-list data-list" style="display: none;">
                <div class="blockelem create-flowy noselect email-nocategory-single">
...
<script type="text/javascript">
    ...
    $('#publish').click(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '{{ route('afterformfillautomateemailflowsubmit') }}',
    ...
    $('.flow-generated').click(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '{{ route('afteradmissionautomateemailflowimport') }}',
            data    : { flowid: flowid},
            success: function(result){
